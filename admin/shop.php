...
<head>
    ...
    <title>All Products and Dresses</title>
...
<body>
    ...
    <div class="container">
        <h1 class="mt-4 mb-4">All Products and Dresses</h1>
                ...
                <tbody style="text-align:center;">
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<a href='delete.php?product_id=" . $row["product_id"] . "' class='btn btn-sm btn-danger'>Delete</a>";
                            echo "</td>";
                            echo "</tr>";
                        }
                    } else {
